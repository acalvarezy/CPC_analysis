...
# Save the figure
plt.savefig(
    "/Users/catalinaalvarez/Google Drive/My Drive/UVA/Research/JanesLab/CPC_project/CPC PAPER/Supplementary material/Experimental support/perturbations_celllines.pdf",
    format="pdf",
    bbox_inches="tight",
    dpi=300
)
