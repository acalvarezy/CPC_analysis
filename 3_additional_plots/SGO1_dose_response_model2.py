...
ax.scatter(x_indices, y_fclog2, color= sns.color_palette("dark")[1], s=240, zorder=3, label='Model prediction')
ax.set_xticks(ticks=x_indices)
ax.set_xticklabels(labels=x_labels, fontsize=16)
...
# 8. Display the graph
plt.tight_layout()
plt.savefig("/Users/catalinaalvarez/Google Drive/My Drive/UVA/Research/JanesLab/CPC_project/CPC PAPER/Supplementary material/Experimental support/SGO1_model_final3.pdf", format="pdf", bbox_inches="tight", dpi=300)
plt.show()